function Sphere(name,type,x,y,r,c,p) {
  this.name = name || "";
  this.type = type || "default";
  this.x = x || 0;
  this.y = y || 0;
  this.target = createVector(x,y);
  this.color = c || [128,128,128];
...
Sphere.prototype.start = function() {
  ...
  if(this.type.includes( "moon" ) ) {
    this.orbit = {x:60,y:60,radius:60,period:0,speed:1,speed_inc:0.5,maxspeed:16,dir:1,offset:0};
  }
}
...
Sphere.prototype.update = function(e) {
    ...
    if(this.type.includes("planet")) {
      ...
      //   this.parent.pos.x + ((sin((this.orbit.period+this.orbit.offset)*this.orbit.dir) * this.orbit.x)), 
      //   this.parent.pos.y + ((cos((this.orbit.period+this.orbit.offset)*this.orbit.dir) * this.orbit.y))
      //   );
    }
